...
function App(props) {
  ...
  let balanceStaked = useContractReader(readContracts, "Staker", "balances", [address]);
  let balanceStakedFloat;
  if (balanceStaked) {
    balanceStakedFloat = ethers.utils.formatEther(balanceStaked);
  }
          ...
          <Route exact path="/">
            ...
            <div style={{ padding: 3 }}>
              <Button
                ...
                onClick={() => {
                  tx(writeContracts.Staker.rescue());
                }}
              >
                Rescue!!!
              </Button>
